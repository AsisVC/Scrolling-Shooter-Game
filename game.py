...
def draw_bg():
    ...
    for x in range(5):
        screen.blit(sky_img, ((x * width) - bg_scroll * 0.5, 0)) # 0.5 represents the speed of each background image movement
    ...
    def move(self, moving_left, moving_right):
        ...
        for tile in world.obstacle_list:
            ...
            if tile[1].colliderect(self.rect.x + dx, self.rect.y, self.width, self.height):
                dx = 0
                # If the IA has hit a wall then make it turn around
        ...
        if self.alive and player.alive:
            ...
            if self.vision.colliderect(player.rect):
                ...
                if self.idling == False:
                    ...
                    # pygame.draw.rect(screen, RED, self.vision) Check the range of enemy's vision
...
death_fades = ScreenFade(2, PINK, 4)
